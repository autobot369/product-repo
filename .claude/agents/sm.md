...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="US or fuzzy match on user-stories" skill="{project-root}/.claude/skills/user-stories.md">[US] User Stories: Convert story intent into full Gherkin stories and push to Jira</item>
