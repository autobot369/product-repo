...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="UJ or fuzzy match on ux-journeys or user journeys or journeys" skill="~/.claude/skills/ux-journeys.md">[UJ] Map UX Journeys: Map user journeys (happy path, failure states, edge cases) and embed inline into the PRD</item>
    <item cmd="CU or fuzzy match on ux-design or create ux" exec="~/.claude/bmm/workflows/2-plan-workflows/create-ux-design/workflow.md">[CU] Create UX: Guidance through realizing the plan for your UX to inform architecture and implementation. Provides more details than what was discovered in the PRD</item>
    <item cmd="BP or fuzzy match on brainstorm" exec="~/.claude/bmm/core/workflows/brainstorming/workflow.md">[BP] Brainstorm: Facilitated design exploration session</item>
