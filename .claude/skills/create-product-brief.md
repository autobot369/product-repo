---
description: Drafts a structured product brief from an idea or initiative description. Covers problem statement, target user, success metrics, and scope. First step of the PM execution workflow — outputs the brief that seeds the PRD. Run before /create-prd.
...
dependencies:
  - Confluence: search space, read related PRDs and research pages
---
