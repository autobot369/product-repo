...
- Read fully and execute: `{project-root}/_bmad/bmm/tasks/remote-context-discovery.md` — search Confluence space `{confluence_search_space}` for existing domain research, industry docs, and prior feature work related to `{{research_topic}}` before starting new research
