...
- Read fully and execute: `{project-root}/_bmad/bmm/tasks/remote-context-discovery.md` — search Confluence space `{confluence_search_space}` for existing market research, customer feedback docs, BA surveys, and competitive analysis related to `{{research_topic}}` before starting new research
