...
This will offer to:
- Publish the completed UX design specification to Confluence under Feature Grooming (space: `{confluence_publish_space}`, parent: `{confluence_feature_grooming_page_id}`)
- Apply labels: `ux-design,bmad-generated`
