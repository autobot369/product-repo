...
# Task References
advancedElicitationTask: '{project-root}/tools/bmm/core/workflows/advanced-elicitation/workflow.xml'
partyModeWorkflow: '{project-root}/tools/bmm/core/workflows/party-mode/workflow.md'
---
